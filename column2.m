...
% Neo_Hookean_Elastic % Mohr_Coulomb & Mohr_Coulomb_rotation & Matsuoka_Nakai
SolidModel.name = 'Matsuoka_Nakai';
Physics.gravity             = [0 -10]           ;                   % gravity acceleration
SolidModel.density          = 2000.0            ;                   % solid density
...
% SolidModel.cohesion         = 0.0               ;                   % cohesion
...
Particle.Count     = 200*Particle.PPC;                   % Total number of particle
...
Particle.N              = SolidModel.N0 * ones(Particle.Count,1);      % Dilatancy state variables
...
writerObj2           = VideoWriter('column2.avi');
