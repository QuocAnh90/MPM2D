...
Particle.S     = zeros(4,pCount);           % value of shape function
Particle.dSx   = zeros(4,pCount);           % value of shape function
Particle.dSy   = zeros(4,pCount);           % value of shape function
